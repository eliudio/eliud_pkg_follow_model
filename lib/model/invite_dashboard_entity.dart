...
class InviteDashboardEntity implements EntityBase {
  final String? appId;
  final String? description;
  final List<MemberActionEntity>? memberActions;
  final StorageConditionsEntity? conditions;

  InviteDashboardEntity({
    required this.appId,
    this.description,
    this.memberActions,
    this.conditions,
  ...
  InviteDashboardEntity copyWith({
    String? documentID,
    String? appId,
    String? description,
  ...
  @override
  InviteDashboardEntity switchAppId({required String newAppId}) {
