...
class _FollowRequestsDashboardDropdownButtonWidgetState
  ...
  void didChangeDependencies() {
    bloc = BlocProvider.of<FollowRequestsDashboardListBloc>(context);
...
//        final values = state.values;
                ...
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      hint: text(widget.app, context,
                          'Select a followRequestsDashboard'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    label: 'Update',
                    onPressed: () {
                      updateComponent(context, widget.app,
                          'followRequestsDashboards', value, (newValue, _) {
                        setState(() {
                          value = value;
                        });
                      });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<FollowRequestsDashboardListBloc>(context)
        .add(FollowRequestsDashboardChangeQuery(
