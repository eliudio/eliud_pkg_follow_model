...
class _FollowingDashboardDropdownButtonWidgetState
  ...
  void didChangeDependencies() {
    bloc = BlocProvider.of<FollowingDashboardListBloc>(context);
...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      value: value,
                      hint: text(
                          widget.app, context, 'Select a followingDashboard'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    onPressed: () {
                      updateComponent(
                          context, widget.app, 'followingDashboards', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<FollowingDashboardListBloc>(context)
        .add(FollowingDashboardChangeQuery(
