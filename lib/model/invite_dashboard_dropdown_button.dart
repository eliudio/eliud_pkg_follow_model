...
typedef InviteDashboardChanged = Function(
  String? value,
  int? privilegeLevel,
);

/* 
 * InviteDashboardDropdownButtonWidget is the drop down widget to allow to select an instance of InviteDashboard
 */
class InviteDashboardDropdownButtonWidget extends StatefulWidget {
  final AppModel app;
  final int? privilegeLevel;
  final String? value;
  final InviteDashboardChanged? trigger;
  final bool? optional;

  /* 
   * construct a InviteDashboardDropdownButtonWidget
   */
  InviteDashboardDropdownButtonWidget(
      {required this.app,
      this.privilegeLevel,
      this.value,
      this.trigger,
  ...
  /* 
   * create state of InviteDashboardDropdownButtonWidget
   */
  @override
  State<StatefulWidget> createState() {
    return _InviteDashboardDropdownButtonWidgetState(value);
  }
}

class _InviteDashboardDropdownButtonWidgetState
    extends State<InviteDashboardDropdownButtonWidget> {
  InviteDashboardListBloc? bloc;
  String? value;

  _InviteDashboardDropdownButtonWidgetState(this.value);
  ...
  List<Widget> _widgets(InviteDashboardModel value) {
    var app = widget.app;
    var widgets = <Widget>[];
...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      value: value,
                      hint:
                          text(widget.app, context, 'Select a inviteDashboard'),
                ...
                : dropdownButton<String>(
                    ...
                    items: items,
                    value: value,
                    hint: text(widget.app, context, 'Select a inviteDashboard'),
                    onChanged: _onValueChange,
                  ),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    onPressed: () {
                      updateComponent(
                          context, widget.app, 'inviteDashboards', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<InviteDashboardListBloc>(context)
        .add(InviteDashboardChangeQuery(
